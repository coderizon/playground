...
## Confirm Dialog (`src/components/common/confirmDialog.js`)
...
## Dataset Recorder Controls (`src/components/dataset/datasetRecorder.js`)
...
## Home Task Grid (`src/pages/home/index.js`)
...
## Collect Empty State (`src/components/class/collectEmpty.js`)
...
## Class Card (`src/components/class/classCard.js`)
...
## Training Panel (`src/components/training/trainingPanel.js`)
...
## Edge Streaming Context (`src/app/store/selectors.js` & `src/components/edge/edgePanel.js`)
...
## Training Summary Panel (`src/components/training/trainingSummaryPanel.js`)
...
Refer back to `src/components/registerComponents.js` for how these are registered in Alpine.
